...
FIELD_COLUMNS: dict[str, tuple[str, str]] = {
    ...
    "peg": ("fund", "peg"),
    "eps_diluted": ("fund", "eps_diluted"),
    "eps_growth": ("fund", "eps_growth"),
    "fcf_per_share": ("fund", "fcf_per_share"),
    "fcf_conversion": ("fund", "fcf_conversion"),
    "roe": ("fund", "roe"),
    "debtor_days": ("fund", "debtor_days"),
    "payable_days": ("fund", "payable_days"),
    "inventory_days": ("fund", "inventory_days"),
    "cash_conversion_cycle": ("fund", "cash_conversion_cycle"),
    "working_capital_days": ("fund", "working_capital_days"),
    "sector": ("inst", "sector"),
