...
// Ported from the Claude Design "ios-frame.jsx" starter component (status
// bar + bezel + home indicator only -- this app never needs the nav bar,
// keyboard or list variants that component also exports). Decorative only:
// used for the phone mockup on LandingPage, never a real device API.
